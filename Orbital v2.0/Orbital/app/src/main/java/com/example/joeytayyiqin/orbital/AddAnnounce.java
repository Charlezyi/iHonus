...
public class AddAnnounce extends AppCompatActivity {
    ...
    private void addNewAnnounce() {
        ...
        Toast.makeText(AddAnnounce.this, "Announcement Added!", Toast.LENGTH_SHORT).show();
    }

    private void backToMainActivity() {
        Intent intent = new Intent(AddAnnounce.this, Announcements.class);
